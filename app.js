...
stock.push(new Producto(12, "Cepillo 3M para pasaruedas", 3000, "./assets/img/CPAS1_500x.webp", "cepillo"));
stock.push(new Producto(13, "Guante de lavado premium", 3800, "./assets/img/guante_lavadol.jpg", "micros"));
stock.push(new Producto(14, "Microfibra Waffle de secado (60x40 cm.)", 2500, "./assets/img/microfibra-abc-waffle.jpg", "micros"));
stock.push(new Producto(15, "Microfibra amarilla gold pelo corto (40x40 cm.)", 1000, "./assets/img/microfibra_lavado.jpg", "micros"));
stock.push(new Producto(16, "Microfibra amarilla pulido (40x40 cm.)", 1400, "./assets/img/microfibra_pl_pc.jpg", "micros"));
